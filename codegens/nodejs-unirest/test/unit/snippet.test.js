...
describe('nodejs unirest convert function', function () {
  describe('Convert function', function () {
    ...
    it('should return snippet with ES6 features', function () {
      ...
      convert(request, options, function (error, snippet) {
        ...
        expect(snippetArray).to.include(
          `const req = unirest('${mainCollection.item[0].request.method}', ` +
    ...
    it(
      'should return snippet with followRedirect function having ' +
        'parameter false for no follow redirect',
      function () {
        request = new sdk.Request(mainCollection.item[0].request);
        options = {
    ...
    it('should generate valid snippet for single/double quotes in url', function () {
      ...
      convert(request, {}, function (error, snippet) {
        ...
        expect(snippet).to.include(
          "'https://postman-echo.com/get?query1=b\\'b&query2=c\"c'"
        );
      });
    });
  });
